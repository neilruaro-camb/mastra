...
- Adds configurable TTL (Time To Live) support for `DynamoDBStore`, enabling automatic data expiration for different entity types. ([#11838](https://github.com/mastra-ai/mastra/pull/11838))
