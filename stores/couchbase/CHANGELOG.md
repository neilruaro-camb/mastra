...
- dependencies updates: ([#10128](https://github.com/mastra-ai/mastra/pull/10128))
  - Updated dependency [`couchbase@^4.6.0` ↗︎](https://www.npmjs.com/package/couchbase/v/4.6.0) (from `^4.5.0`, in `dependencies`)
