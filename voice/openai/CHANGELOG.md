...
- Add configurable options support for OpenAI. ([#8063](https://github.com/mastra-ai/mastra/pull/8063))
...
- feat(voice): Add configurable options support for OpenAI. ([#8063](https://github.com/mastra-ai/mastra/pull/8063))
