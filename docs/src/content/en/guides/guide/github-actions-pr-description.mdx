---
title: "Guide: Automating Multi-Language PR Descriptions in GitHub Actions | Mastra | Guides"
...
- Give your agent [tools](/docs/tools-mcp/overview) to fetch additional context
